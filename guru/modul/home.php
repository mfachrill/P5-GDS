							...
							<div class="card full-height">
								<div class="card-body">
									<div class="card-title">
										<center>
											<img src="../assets/img/wikrama.jpeg" width="100">
											<br>
											<b></b>
										</center>
									</div>
									<div class="card-category">
										<center>
										Alamat : Jl. Raya Wangun Kel. Sindangsari Sindangsari, Kec. Bogor Timur, Kota Bogor
	<br>Email : smkWikrama.sch.id 
										</center>
									</div>
									...
									<div class="tab-content mt-2 mb-3" id="pills-with-icon-tabContent">
										...
										<div class="tab-pane fade" id="pills-contact-icon" role="tabpanel" aria-labelledby="pills-contact-tab-icon">
											<p>
												...
												Aplikasi Absensi siswa ini dibuat untuk mendokumentasikan Gerakan disiplin Siswa Aplikasi sangat Mudah digunakan (Berbasis Web)
											</p>
										</div>
									</div>
								</div>
