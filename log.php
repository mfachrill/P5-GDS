                    ...
                    <div class="container">
                        <div class="page-inner py-5">
                            <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
                                <div>
                                    <h2 class="text-white pb-2 fw-bold">SMK WIKRAMA BOGOR</h2>
                                   
                                </div>
                                <div class="ml-md-auto py-2 py-md-0">
                                    <a href="#" class="btn btn-white btn-border btn-round mr-2">Alamat : Jl. Raya Wangun Kel. Sindangsari Sindangsari, Kec. Bogor Timur, Kota Bogor</a>
                                </div>
                            </div>
                        </div>
                    </div>
