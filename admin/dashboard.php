...
<head>
	...
	<title>GDS Siswa | Aplikasi GDS</title>
		...
		<div class="main-header">
			...
			<div class="logo-header" data-background-color="blue">
				...
				<a href="dashboard.php" class="logo">
					<b class="text-white">SMK WIKRAMA BOGOR</b>
				</a>
					...
					<div class="user">
						...
						<div class="info">
							<a data-toggle="collapse" href="#collapseExample" aria-expanded="true">
								<span>
									<?=$data['nama_lengkap'] ?>
									<span class="user-level">Penanggung Jawab GDS</span>
						...
						<li class="nav-item">
							...
							<div class="collapse" id="base">
								<ul class="nav nav-collapse">
									...
									<li>
										<a href="?page=walas">
											<span class="sub-item"> Pembimbing Siswa </span>
										</a>
									</li>
